    ...
    <div class="row">
        <div class="col-lg-9 col-md-9 mx-auto">
            <div class="card card-body bg-light my-5">
                ...
                <form action="<?php echo URLROOT; ?>/pictures/edit/<?php echo $data['id'] ;?>" method="post"
                    ...
                    <div class="form-group">        
                        ...
                        <input type="file" name="image" class="form-control <?php echo (!empty($data['image_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['picture']->image; ?>"/>
