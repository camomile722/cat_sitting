            ...
            <div class="card card-body bg-light my-5">
                ...
                <form action="<?php echo URLROOT; ?>/sliders/edit/<?php echo $data['id'] ;?>" method="post"
                    ...
                    <div class="form-group">        
                        ...
                        <input type="file" name="image_1" class="form-control <?php echo (!empty($data['image_1_err'])) ? 'is-invalid' : ''; ?>" />
                        <span class="invalid-feedback"><?php echo $data['image_1_err']; ?></span>
                        </div> 
                     
                        <div class="form-group">        
                        <label for="image_2">Slider 2 Upload: <sup>*</sup></label>
                        <input type="file" name="image_2" class="form-control <?php echo (!empty($data['image_2_err'])) ? 'is-invalid' : ''; ?>" />
                        <span class="invalid-feedback"><?php echo $data['image_2_err']; ?></span>
                        </div> 

                        <div class="form-group">        
                        <label for="image_3">Slider 3 Upload: <sup>*</sup></label>
                        <input type="file" name="image_3" class="form-control <?php echo (!empty($data['image_3_err'])) ? 'is-invalid' : ''; ?>" value=""/>
