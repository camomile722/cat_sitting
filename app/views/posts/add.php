...
<div class="container my-5">
    <div class="row">
        <div class="col-lg-9 col-md-9 mx-auto">
            <a href="<?php echo URLROOT;?>/posts/index" class="btn btn-secondary light"><strong>Zurück</strong></a>
        </div>
    </div>
                ...
                <form action="<?php echo URLROOT; ?>/posts/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group" ">
                      <label for=" body">Text: <sup>*</sup></label>
                        ...
                        <input
                            class="form-control <?php echo (!empty($data['title_image_err'])) ? 'is-invalid' : '' ;?>"
                            type="text" name="title_image" value="<?php echo $data['title_image'] ?>">
